...
CREATE SERVICE "insertInscription" TYPE 'RAW' AUTHORIZATION OFF USER "dba" METHODS 'GET' AS call dba.insertInscription(:Nom,:Prenom,Adresse,Identifiant,Mdp,Mail);
